...
// DAYBREAK
    ...
    // TITANS_OF_ADVENTURE 17, 18, 19, 60
    {
        id: 669,
        name: 'Set 18, Dragonborn Rogue',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'draconato, ladino',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 670,
        name: 'Set 18, Elf Paladin',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'elfo, paladino, suporte, masculino, homem',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 671,
        name: 'Set 60, Githyanki Druid',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'druida, magia, magico, passaro, cajado',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 672,
        name: 'Set 17, Gnome Mage',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'gnomo, gnoma, magico, magica, mago, maga, cajado, feminino, mulher',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 673,
        name: 'Set 19, Gnome Rogue',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'gnomo, gnoma, feminino, mulher, ladino, ladina, faca, adaga',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 674,
        name: 'Set 18, Gnome Warrior',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'gnomo, gnoma, feminino, mulher, guerreiro, guerreira, espada, escudo, cabelo enrolado, cacheado, ondulado',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 675,
        name: 'Set 60, Hafling Monk',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'monge, careca, masculino, homem',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 676,
        name: 'Set 19, Half Orc Fighter',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'meio orc, meio ogro, masculino, homem, guerreiro, lutador',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 677,
        name: 'Set 19, Half Orc Hunter',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'meio orc, meio ogro, masculino, homem, caçador, arqueiro, arco',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 678,
        name: 'Set 17, Human Warrior',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'humano, guerreiro, masculino, homem, escudo, machado',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 679,
        name: 'Set 17, Tiefling Fighter',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'lutador, guerreiro, guerreira, feminino, mulher, lutador, lutadora, espada, duas mão, duas maõs',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: null,
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 680,
        name: 'Set 60, Tiefling Paladin',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'paladino, suporte, escudo, espada, masculino, homem',
        observation: 'Na compra de 3 o preço fica R$15 e na de 10 R$13',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    // CURSED SANDS
    {
        ...
        size: 'especial',
        price: 600.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'piramide, egito, areia',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/pyramid.webp',
    },
    {
        id: 682,
        name: 'Aarogan Wisdom of Ur',
        size: 'especial',
        price: 55.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, esfinge, criatura, animal, animais, asa, voador',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/aarogan-wisdom-of-ur.webp',
    },
    {
        id: 683,
        name: 'Ancestral Skeletons Bow',
        size: '28mm|33mm',
        price: 16.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, esqueleto, morto vivo, arqueiro, arco',
    ...
    {
        id: 684,
        name: 'Ancestral Skeletons Spear',
        size: '28mm|33mm',
        price: 16.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, esqueleto, morto vivo, lança',
        observation: 'Na compra de 3 o preço fica R$15',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 685,
        name: 'Ancestral Skeletons Swords',
        size: '28mm|33mm',
        price: 16.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, esqueleto, morto vivo, espada, escudo',
        observation: 'Na compra de 3 o preço fica R$15',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    {
        id: 686,
        name: 'Cursed Sands Boat',
        size: 'especial',
        price: 140.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, esqueleto, morto vivo, barco, item, itens, cenário',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/cursed-sands-boat.webp',
    },
    {
        id: 687,
        name: 'Cursed Sands Crusader',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, humano, aventureiro, masculino, homem, patrulheiro',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/cursed-sands-crusader.webp',
    },
    {
        id: 688,
        name: 'Cursed Sands Lioness',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, humano, catfolk, gato, criatura, animal, animais',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/cursed-sands-lioness.webp',
    },
    {
        id: 689,
        name: 'Cursed Sands Pathfinder',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, humano, humana, mulher, feminino, aventureiro, patrulheiro, aventureira, patrulheira',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/cursed-sands-pathfinder.webp',
    },
    {
        id: 690,
        name: 'Jeweled Scarabaeus 1',
        size: 'especial',
        price: 40.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, escorpiao, escaravelho, criatura, monstro, morto vivo',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/jeweled-scarabaeus-1.webp',
    },
    {
        id: 691,
        name: 'Jeweled Scarabaeus 2',
        size: 'especial',
        price: 40.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, escorpiao, escaravelho, criatura, monstro, morto vivo',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/jeweled-scarabaeus-2.webp',
    },
    {
        id: 692,
        name: 'Jeweled Scarabaeus 3',
        size: 'especial',
        price: 40.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, escorpiao, escaravelho, criatura, monstro, morto vivo',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/jeweled-scarabaeus-3.webp',
    },
    {
        id: 693,
        name: 'Nanuru Cunning of Ur 1',
        size: 'especial',
        price: 25.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, chacau, anubis, criatura, monstro',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/nanuru-cunning-of-ur-1.webp',
    },
    {
        id: 694,
        name: 'Nanuru Cunning of Ur 2',
        size: 'especial',
        price: 25.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, chacau, crocodilo, jacare, criatura, monstro',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/nanuru-cunning-of-ur-2.webp',
    },
    {
        id: 695,
        name: 'Sethorus the Relentless',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, morto vivo, mumia',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/sethorus-the-relentless.webp',
    },
    {
        id: 696,
        name: 'Sharifa the Timeless',
        size: '28mm|33mm',
        price: 20.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, morto vivo, mumia, feminino, mulher, cobra',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/sharifa-the-timeless.webp',
    },
    {
        id: 697,
        name: 'Un-Nefer Curse Apostole',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.CURSED_SANDS,
        tag: 'egito, areia, morto vivo, mumia, homem, masculino',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/cursed-sands/un-nefer-curse-apostole.webp',
    },

    // HIGHBORNE_ELVES_AND_UNDEAD_DOMINION
    {
        id: 698,
        name: 'Centaur',
        size: '28mm|33mm',
        ...
        tag: 'Centauro, Selvagem, lança, criatura, masculino, homem',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion/centaur.webp',
    },
    {
        id: 699,
        name: 'Satyr',
        ...
        price: 18.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION,
        tag: 'Satiro, Selvagem, tribal, criatura',
        observation: 'Na compra de 3 o preço fica R$15',
        options: ['a', 'b', 'c'],
        discounts: [
            {minQty: 3, price: 15, type: 'fixed'},
    ...
    },
    {
        ...
        options: ['a', 'b', 'c'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion/banshees.webp',
    },
    {
        id: 701,
        name: 'Headless Horsemans',
        size: '28mm|33mm',
        price: 40.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION,
    ...
    {
        id: 706,
        name: 'Maiden of the Phoenix',
        size: '28mm|33mm',
        price: 20.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION,
        tag: 'elfo, guarda, realeza, feminino, mulher, arqueiro',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion/maiden-of-the-phoenix.webp',
    },
    {
        id: 707,
        name: 'Sisters of the Phoenix',
        size: 'especial',
        price: 210.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION,
        tag: 'elfo, guarda, realeza, feminino, mulher, arqueiro',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion/sisters-of-the-phoenix.webp',
    },
    {
        id: 708,
        name: 'Sky Barage',
    ...
    // DRAGON EMPIRE 2
    {
        ...
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'arma, rifle, arma de fogo, homem, masculino, atirador',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/taganashi-1.webp',
    },
    {
        id: 710,
        name: 'Taganashi 2',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/taganashi-2.webp',
    },
    {
        id: 711,
        name: 'Taganashi 3',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/taganashi-3.webp',
    },
    {
        id: 712,
        name: 'Taganashi 4',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/taganashi-4.webp',
    },
    {
        id: 713,
        name: 'Ninja 1',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'homem, masculino, ninja, shuriken',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/ninja-1.webp',
    },
    {
        id: 714,
        name: 'Ninja 2',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/ninja-2.webp',
    },
    {
        id: 715,
        name: 'Ninja 3',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/ninja-3.webp',
    },
    {
        id: 715,
        name: 'Yuko',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'mulher, feminino, espada, samurai, katana',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/yuko.webp',
    },
    {
        id: 716,
        name: 'Raion',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'homem, masculino, criatura, orc, ogro, katana',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/raion.webp',
    },
    {
        id: 717,
        name: 'Kitsune',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'criatura, raposa, animal, magia',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/kitsune.webp',
    },
    {
        id: 718,
        name: 'Komainu 1',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'samurai, homem, masculino, montaria, animal, criatura',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/komainu-1.webp',
    },
    {
        id: 719,
        name: 'Komainu 2',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/komainu-2.webp',
    },
    {
        id: 720,
        name: 'Kirin',
        ...
        price: 35.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'samurai, homem, masculino, montaria, animal, criatura, cavalo, unicórnio',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/kirin.webp',
    },
    {
        id: 721,
        name: 'Tianlong',
        ...
        price: 280.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'dragão, criatura, monstro, magia, voador, samurai, montaria',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/dragon-empire/tianlong.webp',
    },
    {
        id: 722,
        name: 'Archers',
        ...
        price: 18.00,
        type: TypeEnum.DRAGON_EMPIRE,
        tag: 'samurai, arqueiro, arco, flecha, homem, masculino',
        observation: null,
        options: ['a', 'b', 'c'],
        discounts: null,
        image: '/img/catalog/dragon-empire/archers.webp',
    },

    // Highborne Elves And Undead Dominion 2
    {
        id: 723,
        name: 'Grick',
        size: 'especial',
        price: 50.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, tentaculo',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/grick.webp',
    },
    {
        id: 724,
        name: 'Land Sharks',
        ...
        price: 20.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, tubarao, animal',
        observation: null,
        options: ['a', 'b'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/land-sharks.webp',
    },
    {
        id: 725,
        name: 'Grave giants',
        ...
        price: 50.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, morto vivo, cova, zumbi',
        observation: null,
        options: ['a', 'b'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/grave-giants.webp',
    },
    {
        id: 726,
        name: 'Grave Guards',
        ...
        price: 18.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, morto vivo, zumbi, exercito, guarda',
        observation: null,
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/grave-guards.webp',
    },
    {
        id: 727,
        ...
        price: 25.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, morto vivo, zumbi, espectro, fantasma',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/spectral-assassin.webp',
    },
    {
        id: 728,
        name: 'Tooth fairys',
        ...
        price: 15.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, monstro, morto vivo, zumbi, exercito, circo, palhaço',
        observation: null,
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/tooth-fairys.webp',
    },
    {
        id: 729,
        name: 'Light Calvary',
        ...
        price: 35.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'exercito, cavaleiro, montaria, homem, masculino, bardo, arqueiro, guerreiro',
        observation: null,
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/light-calvary.webp',
    },
    {
        id: 730,
        name: 'Lion Calvary',
        ...
        price: 35.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'exercito, cavaleiro, montaria, homem, masculino, arqueiro, guerreiro, elfo',
        observation: null,
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/lion-calvary.webp',
    },
    {
        id: 731,
        name: 'Lion Guards',
        ...
        price: 18.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'exercito, cavaleiro, montaria, homem, masculino, guerreiro, elfo, bardo',
        observation: null,
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/lion-guards.webp',
    },
    {
        id: 732,
        name: 'Lions',
        ...
        price: 23.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, animal, leão, cenário',
        observation: null,
        options: ['a', 'b', 'c'],
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/lions.webp',
    },
    {
        id: 733,
        name: 'Pheonix A',
        ...
        price: 160.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'criatura, animal, cenário, monstro, fenix, passaro, voador',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/pheonix-a.webp',
    },
    {
        id: 734,
        name: 'Pheonix B',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/pheonix-b.webp',
    },
    {
        id: 735,
        name: 'Pheonix Archmange',
        size: '28mm|33mm',
        price: 25.00,
        type: TypeEnum.HIGHBORNE_ELVES_AND_UNDEAD_DOMINION_2,
        tag: 'fenix, maga, magia, mulher, feminino, mago, animal, mascote, aragemo, aragema, bruxa',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/highborne-elves-and-undead-dominion-2/pheonix-b.webp',
...

    {
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/titans-of-adventure-61/dwarf-warrior.webp',
    },
    {
        id: 737,
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/titans-of-adventure-61/tiefling-artificer.webp',
    },
    {
        id: 738,
    ...
    {
        id: 759,
        name: 'Set 63, Artificer Tiefling',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'tiefling, artificie, feminino, tecnologia',
        observation: null,
        options: ['a','b','c','d'],
        discounts: null,
        image: '/img/catalog/titans-of-adventure-63/artificer-tiefling.webp',
    },
    {
        id: 760,
        name: 'Set 63, Angel Cleric',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'anjo, humano, clerigo, sagrado',
        observation: null,
        options: ['a','b','c','d'],
        discounts: null,
        image: '/img/catalog/titans-of-adventure-63/angel-cleric.webp',
    },
    {
        id: 761,
        name: 'Set 63, Human Barbarian',
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.TITANS_OF_ADVENTURE,
        tag: 'humano, barbaro, selvagem, guerreiro',
        observation: null,
        options: ['a','b','c','d'],
        discounts: null,
        image: '/img/catalog/titans-of-adventure-63/human-barbarian.webp',
    },
    ...
    // DRAKSKULL MENACE
    {
        ...
        size: '28mm|33mm',
        price: 25.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'orc, necromante, lider',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/drakskull-manace/lord-on-foot.webp',
    },
    {
        id: 763,
        name: 'DoctOrk',
        ...
        price: 20.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'medico, doido, orc, cientista',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/drakskull-manace/doctorrk.webp',
    },
    {
        id: 764,
        name: 'Bloodwulf Riders',
        size: '28mm|33mm',
        price: 35.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'orc, lobos, guerreiros, montaria',
        observation: 'Na compra de no mínimo 3 o preço diminui para 30 R$',
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: [
            { minQty: 3, price: 30, type: 'fixed' },
        ],
        image: '/img/catalog/drakskull-manace/bloodwulf-riders.webp',
    },
    {
        id: 765,
        name: 'Hydra',
        ...
        price: 170.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'hydra, hidra, monstro, criatura',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/drakskull-manace/hydra.webp',
    },
    {
        id: 766,
        name: 'Medusa',
        ...
        price: 20.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'medusa, feminino,arco, lança',
        observation: 'Na compra de no mínimo 3 o preço diminui para 16 R$',
        options: ['a', 'b', 'c'],
        discounts: [
            { minQty: 3, price: 16, type: 'fixed' },
        ],
        image: '/img/catalog/drakskull-manace/medusa.webp',
    },
    {
        id: 767,
        name: 'Minotaur',
        ...
        price: 20.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'minotauro, machado, criatura, monstro',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/drakskull-manace/minotaur.webp',
    },
    {
        id: 768,
        name: 'Noise Ghost',
        ...
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'goblin, fantasma',
        observation: 'Na compra de no mínimo 3 o preço diminui para 10 R$',
        options: ['a', 'b', 'c'],
        discounts: [
            { minQty: 3, price: 10, type: 'fixed' },
        ],
        image: '/img/catalog/drakskull-manace/noise-ghost.webp',
    },
    {
        id: 769,
        name: 'Unded Wyvern',
        ...
        price: 165.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'Morto vivo, dragao, esqueleto',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/drakskull-manace/unded-wyvern.webp',
    },
    {
        id: 770,
        name: 'Zomblins',
        ...
        price: 13.00,
        type: TypeEnum.DRAKSKULL_MENACE,
        tag: 'goblin, Morto vivo, fungo, infestado',
        observation: 'Na compra de no mínimo 3 o preço diminui para 10 R$',
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: [
            { minQty: 3, price: 10, type: 'fixed' },
        ],
        image: '/img/catalog/drakskull-manace/zomblins.webp',
    },
    ...
    // LOST CRUSADE
    {
        ...
        size: '28mm|33mm',
        price: 18.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Anão, Paladino, paladin',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/dwarf-veteran.webp',
    },
    {
        id: 772,
        name: 'Fereal',
        ...
        price: 20.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'paladina, feminino, humana, cruzada, mulher',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/fereal.webp',
    },
    {
        id: 773,
        name: 'Fereal Wings',
        ...
        price: 25.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'paladina, feminino, humano, anjo, cruzada',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/fereal-wings.webp',
    },
    {
        id: 774,
        name: 'Hierophant',
        ...
        price: 20.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Bandeira, mascara, cruzada',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/hierophant.webp',
    },
    {
        id: 775,
        name: 'High Lord',
        ...
        price: 25.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,Sagrado,Humano, cruzada',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/high-lord.webp',
    },
    {
        id: 776,
        name: 'High Lord Winged Lion',
        size: '28mm|33mm',
        price: 75.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,Sagrado,Humano, cruzada, leão, criatura, voador, animal, montaria',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/high-lord-winged-lion.webp',
    },
    {
        id: 777,
        name: 'High Lord on Lion',
        size: '28mm|33mm',
        price: 65.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,Sagrado,Humano, cruzada, leão, criatura, voador, animal, montaria',
        ...
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/high-lord-on-lion.webp',
    },
    {
        id: 778,
        name: 'Lion',
        ...
        price: 55.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'cruzada, leão, criatura, voador, animal, montaria',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/lion.webp',
    },
    {
        id: 779,
        name: 'Inquisitors 1',
        ...
        price: 18.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,inquisidor, cruzada',
        observation: 'Na compra de no mínimo 3 o preço diminui para 15 R$',
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: [
            { minQty: 3, price: 15, type: 'fixed' },
        ],
        image: '/img/catalog/lost-crusade/inquisitors-1.webp',
    },
    {
        id: 780,
        name: 'Inquisitors 2',
        ...
        image: '/img/catalog/lost-crusade/inquisitors-2.webp',
    },
    {
        id: 781,
        name: 'Steam Engine',
        ...
        price: 140.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Montaria, canhão, veiculo, sagrado',
        observation: null,
        options: null,
        discounts: null,
        image: '/img/catalog/lost-crusade/steam-engine.webp',
    },
    {
        id: 782,
        name: 'Templars',
        ...
        price: 18.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,inquisidor, cruzada, templarios, sagrado',
        observation: 'Na compra de no mínimo 3 o preço diminui para 15 R$',
        options: ['a', 'b', 'c', 'd', 'e', 'f'],
        discounts: [
            { minQty: 3, price: 15, type: 'fixed' },
        ],
        image: '/img/catalog/lost-crusade/templars.webp',
    },
    {
        id: 783,
        name: 'Templars Cavalry',
        size: '28mm|33mm',
        price: 35.00,
        type: TypeEnum.LOST_CRUSADE,
        tag: 'Paladin,inquisidor, cruzada, templarios, sagrado, montaria, cavalo',
        observation: 'Na compra de no mínimo 3 o preço diminui para 30 R$',
        options: ['a', 'b', 'c', 'd', 'e'],
        discounts: [
            { minQty: 3, price: 30, type: 'fixed' },
        ],
        image: '/img/catalog/lost-crusade/templars-cavalry.webp',
    },
];